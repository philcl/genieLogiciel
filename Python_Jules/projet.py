...
for i in temp:
	...
	resultat += "\n"
	resultat += "{\"token\":\"96b29b22-cefb-4699-93b9-9fcc97aa003e\", \"clientID\":21, \"demandeur\":{\"SIRET\":12345678912349, \"idAdresse\":12, \"demandeur\":{\"demandeurId\":" + i[9] + ",\"nom\":\"" + i[10] + "\",\"prenom\":\"" + i[11] + "\",\"sexe\":\"M\"}, \"telephone\":\"0645789878\"}} \n"
	resultat += "###\n\n"
